...
public class ShieldManager {
	...
	public static synchronized void setEscudo(Jugador jug , Escudo nuevo_escudo) throws InterruptedException {
		
			System.out.println("entre a la operacion");
			Escudo viejo_escudo = jug.getEscudo();
			jug.setEscudo(nuevo_escudo);
			
			Thread.sleep(7000); //de alguna forma, si otro thread quiere ingresar al metodo, quiero que el thread que
